...
public class Settings extends TemplateActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String savedEmail = sharedPref.getString(SAVED_EMAIL, "me@liupeng.info");
        etEmail.setText(savedEmail);
        etPassword.setText("aA123321!");
        AdminUser.host = "http://182.92.100.162";
        AdminUser.cdnHost = "http://182.92.100.162";
        AdminUser.uiconfId = 23448189;
    }
